...
const AllProducts = () => {
  ...
  return (
    <>
      <div className="container mx-[9re]">
                  ...
                  <div className="flex">
                    ...
                    <div className="p-4 flex flex-col justify-around">
                      ...
                      <div className="flex justify-between">
                        <Link
                          to={`/admin/product/update/${product._id}`}
                          className="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white
                        ...
                        <p className="text-sm pl-2 text-center my-auto md:p-">${product?.price}</p>
                      </div>
                    </div>
                  </div>
                </Link>
